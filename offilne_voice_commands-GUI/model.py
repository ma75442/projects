...
#import eda		#FOR RUNNING THE PROGRAM FOR PLOTS AND FEATURE EXTRACTION
...
config = Config(mode = 'conv') #For selecting between CNN and RNN
...
with open('pickles/data.pickle', 'wb') as handle:
